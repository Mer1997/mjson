...
static void test_parse_root_not_singular(){
    TEST_PARSE_ERROR(JSON_PARSE_ROOT_NOT_SINGULAR, "null x");

    /* invalid number */
    TEST_PARSE_ERROR(JSON_PARSE_ROOT_NOT_SINGULAR, "0123"); /* after zero should be '.' or nothing */
    TEST_PARSE_ERROR(JSON_PARSE_ROOT_NOT_SINGULAR, "0x0");
    TEST_PARSE_ERROR(JSON_PARSE_ROOT_NOT_SINGULAR, "0x123");
}
...
static void test_parse_miss_quotation_mark(){
    TEST_PARSE_ERROR(JSON_PARSE_MISS_QUOTATION_MARK, "\"");
    TEST_PARSE_ERROR(JSON_PARSE_MISS_QUOTATION_MARK, "\"abc");
}

static void test_parse_invalid_string_escape(){
    TEST_PARSE_ERROR(JSON_PARSE_INVALID_STRING_ESCAPE, "\"\\v\"");
    TEST_PARSE_ERROR(JSON_PARSE_INVALID_STRING_ESCAPE, "\"\\'\"");
    TEST_PARSE_ERROR(JSON_PARSE_INVALID_STRING_ESCAPE, "\"\\0\"");
    TEST_PARSE_ERROR(JSON_PARSE_INVALID_STRING_ESCAPE, "\"\\x12\"");
}
...
static void test_parse_miss_key(){
    TEST_PARSE_ERROR(JSON_PARSE_MISS_KEY, "{:1,");
    TEST_PARSE_ERROR(JSON_PARSE_MISS_KEY, "{1:1,");
    TEST_PARSE_ERROR(JSON_PARSE_MISS_KEY, "{true:1,");
    TEST_PARSE_ERROR(JSON_PARSE_MISS_KEY, "{false:1,");
    TEST_PARSE_ERROR(JSON_PARSE_MISS_KEY, "{null:1,");
    TEST_PARSE_ERROR(JSON_PARSE_MISS_KEY, "{[]:1,");
    TEST_PARSE_ERROR(JSON_PARSE_MISS_KEY, "{{}:1,");
    TEST_PARSE_ERROR(JSON_PARSE_MISS_KEY, "{\"a\":1,");
}
...
static void test_access_object(){
    ...
    for (j = 0; j <= 5; j += 5){
        ...
        for (i = 0; i < 10; i++){
            ...
            EXPECT_TRUE(index != JSON_KEY_NOT_EXIST);
